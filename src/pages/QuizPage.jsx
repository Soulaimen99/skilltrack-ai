    ...
    <div className="container">
      ...
      {quiz.completed ? (
        ...
        <div className="quiz-in-progress">
          <div className="quiz-header-actions" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
            <div className="quiz-progress" style={{ flex: '1' }}>
              <div className="progress-bar" style={{ height: '10px', backgroundColor: '#e0e0e0', borderRadius: '5px', overflow: 'hidden' }}>
                <div 
                  ...
                  style={{ width: `${progressPercentage}%`, height: '100%', backgroundColor: '#4caf50' }}
                ></div>
              </div>
              <span className="progress-text" style={{ fontSize: '14px', color: '#666', marginTop: '5px', display: 'block' }}>
